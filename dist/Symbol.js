(function (factory) {
    ...
    class Symbol extends Word_1.Word {
        /**
         ...
         */
        isChunkLabel() {
            if (Word_1.Word.isPunctuation(this.name) ||
    ...
    Symbol.nonTerminalList = ["ADJP", "ADVP", "CC", "CD", "CONJP", "DT", "EX", "FRAG", "FW", "IN", "INTJ", "JJ", "JJR",
        ...
        "WRB", "X", "-NONE-"];
    Symbol.phraseLabels = ["NP", "PP", "ADVP", "ADJP", "CC", "VG"];
    Symbol.sentenceLabels = ["SINV", "SBARQ", "SBAR", "SQ", "S"];
    Symbol.verbLabels = ["VB", "VBD", "VBG", "VBN", "VBP", "VBZ", "VERB"];
    Symbol.VPLabel = "VP";
});
