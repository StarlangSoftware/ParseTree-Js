...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "./ConstituentSpan", "./NodeCollector", "./ParseNode", "./ParseTree", "./SearchDirectionType", "./Symbol", "./TreeBank", "./ParallelTreeBank", "./NodeCondition/IsEnglishLeaf", "./NodeCondition/IsLeaf", "./NodeCondition/NodeCondition"], factory);
    }
